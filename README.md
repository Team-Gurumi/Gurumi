...
**Gurumi**는 P2P 구조 기반의 분산 클라우드 실험용 프로젝트로, 수요자-공급자 간 안전한 작업 전송 및 처리를 실현하는 Mutual Cloud 모델입니다. 본 저장소는 현재 유지보수되지 않으며(Archived), 아이디어 검증 및 연구 기록 보존을 위해 공개해 둔 상태입니다.

실제 논문 및 최종 구현체는 본 저장소가 아닌, 이후 진행된 별도의 프로젝트를 따릅니다.
